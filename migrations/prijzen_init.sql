...
-- Besluiten Peter 04-09: hosting €25 per maand, verplicht in élke route (ook tijdens de twaalf
-- gespreide maanden); onderhoud €25 per maand en overal optioneel, dus samen €50; het
...
-- SEED-START (gegenereerd door scripts/bouw-prijzen-migratie.mjs)
insert into public.stolkwebdesign_prijzen (sleutel, groep, label, bedrag, eenheid, toelichting, volgorde) values
  ...
  ('hosting.maand', 'Hosting en onderhoud', 'Webhosting en beveiliging', 25, 'per maand', 'Server, SSL-certificaat, back-ups en monitoring. Verplicht in elke route: bij een pakket ineens, tijdens de twaalf gespreide maanden, en bij Basis CMS. Zit nergens in inbegrepen. Het onderhoud van het CMS (Basis CMS) staat hier los van.', 10),
  ('onderhoud.maand', 'Hosting en onderhoud', 'Onderhoud', 25, 'per maand', 'Optioneel, in elke route. Updates van de techniek, back-ups, beveiligingscontrole en kleine tekstwijzigingen (even mailen). Geen nieuwe pagina''s of onderdelen; dat is meerwerk tegen een vaste prijs. Samen met de hosting is dat €50 per maand; de site rekent dat zelf uit.', 15),
