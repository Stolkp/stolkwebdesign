...
-- Besluit Peter 04-09: hosting €25, hosting plus onderhoud €50, en Basis CMS komt bovenop de
-- hosting (hosting zit er niet in).
insert into public.stolkwebdesign_prijzen (sleutel, groep, label, bedrag, eenheid, toelichting, volgorde) values
  ...
  ('hosting.maand',             'Hosting en onderhoud', 'Webhosting en beveiliging',   25, 'per maand', 'Server, SSL-certificaat, back-ups en monitoring. Komt bij elk pakket en ook bij Basis CMS; zit nergens in inbegrepen.', 10),
  ...
  -- Modules (setup eenmalig + maandbedrag)
  ('module.basis.setup',        'Modules', 'Basis CMS: setup',            149, 'eenmalig',  'Fundering voor alle modules. Login en updates inbegrepen, hosting komt erbij.', 10),
  ('module.basis.maand',        'Modules', 'Basis CMS: per maand',         19, 'per maand', NULL, 11),
  ...
  -- Algemene voorwaarden (contracttekst, los van de tarieven op de site)
  ('voorwaarden.uurtarief',     'Voorwaarden', 'Uurtarief',                60, 'per uur',   'Staat in de algemene voorwaarden (NL en EN). Let op: de project-CLAUDE.md noemde €75; de voorwaarden zijn de contracttekst.', 10),
  ('voorwaarden.aanmaning',     'Voorwaarden', 'Kosten tweede aanmaning',  50, 'eenmalig',  'Artikel betaling in de algemene voorwaarden.', 20),
  ('voorwaarden.onderhoud.maand','Voorwaarden','Onderhoudsovereenkomst',  25, 'per maand', 'Artikel onderhoud in de voorwaarden: geeft recht op één uur onderhoud per maand. Staat los van de hosting van €25 op de site; hetzelfde bedrag, andere afspraak.', 30)
